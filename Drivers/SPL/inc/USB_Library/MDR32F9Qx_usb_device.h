...
/** @addtogroup USB_DEVICE_AND_HID USB DEVICE AND HIC
  * @{
  */
...
/**
  * @brief Request Type Data Transfer Direction enumeration. USB 2.0 Table 9-2, bmRequestType D7
  */
typedef enum
{
...
/**
  * @brief Request Type enumeration. USB 2.0 Table 9-2, bmRequestType D6..5
  */
typedef enum
{
...
/**
  * @brief Standard Setup Request Type enumeration. USB 2.0 Table 9-4
  */
typedef enum
{
    USB_GET_STATUS = 0,
...
/**
  * @brief Standard Descriptor Type enumeration. USB 2.0 Table 9-5
  */
typedef enum
{
    USB_DEVICE                      = 1,
...
/**
  ...
  */
typedef struct {
    uint32_t PULL;  /*!< This member configures the D+ and D- line pulling
